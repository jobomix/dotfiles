...
vim.keymap.set("n", "<M-d>", "<cmd>tab DBUI<CR>")
...
require("lazy").setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>ter", ":split | resize 16 | terminal <CR>", { desc = "[ ] Open a new terminal" })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        -- is found.
        -- typescript = { "biome", "biome-check", "biome-organize-import" },
        -- typescriptreact = { "biome", "biome-check", "biome-organize-import" },
      },
    },
  },
